...
public class API {
	...
	static {
		...
		API.preffix = String.valueOf("§6§lKITPVP") + " §c\u27a1 ";
		API.msgcooldown = String.valueOf("§6§lKITPVP") + " §c\u27a1 ";
		API.jogadoroff = String.valueOf(API.preffix) + "§cCooldown";
