	...
	public void RodarComando() {
		if (!Main.plugin.getConfig().contains("Feast")) {
			Bukkit.broadcastMessage(
					"§e§lDesert§f§lPvP §7» §cNa tentativa de spawnar o feast, nao foi achado um lugar !");
			return;
		}
		...
		AddBau.getBlockInventory().setItem(slot,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau.getBlockInventory().setItem(slot2,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau.getBlockInventory().setItem(slot3,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau2.getBlockInventory().setItem(slot,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau2.getBlockInventory().setItem(slot2,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau2.getBlockInventory().setItem(slot3,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau3.getBlockInventory().setItem(slot,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau3.getBlockInventory().setItem(slot2,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau3.getBlockInventory().setItem(slot3,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau4.getBlockInventory().setItem(slot,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau4.getBlockInventory().setItem(slot2,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau4.getBlockInventory().setItem(slot3,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau5.getBlockInventory().setItem(slot,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau5.getBlockInventory().setItem(slot2,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau5.getBlockInventory().setItem(slot3,
				new ItemStack(Material.getMaterial(lista[new Random().nextInt(lista.length)])));
		AddBau.update();
		AddBau2.update();
		AddBau3.update();
